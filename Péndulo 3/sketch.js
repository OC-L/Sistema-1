...
function initializeAudio() {
  ...
  //const chorus = new Tone.Chorus(5, 2.5, 1).toDestination().start();
  ...
  let flavour = "minor";
  scale = Tonal.Scale.get("E2" + flavour).notes;
  scale = scale.concat(Tonal.Scale.get("F#2 " + flavour).notes);
  scale = scale.concat(Tonal.Scale.get("C2 " + flavour).notes);
